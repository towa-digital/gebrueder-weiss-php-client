...
class GoodsItemReference implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    const QUALIFIER_PACKITEMID = 'packitemid';
    const QUALIFIER_CARRIERTRACKINGNUMBER = 'carriertrackingnumber';
    const QUALIFIER_CARRIERTRACKINGURL = 'carriertrackingurl';
    ...
    {
        return [
            self::QUALIFIER_PACKITEMID,
            self::QUALIFIER_CARRIERTRACKINGNUMBER,
            self::QUALIFIER_CARRIERTRACKINGURL,
        ];
    }
     ...
     * Sets qualifier
     *
     * @param string|null $qualifier qualifier for the goodsitem
     *
     * @return self
     */
