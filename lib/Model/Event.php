...
class Event implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['event_date_time']) && (mb_strlen($this->container['event_date_time']) > 29)) {
            $invalidProperties[] = "invalid value for 'event_date_time', the character length must be smaller than or equal to 29.";
        }
    ...
    {
        if (!is_null($event_date_time) && (mb_strlen($event_date_time) > 29)) {
            throw new \InvalidArgumentException('invalid length for $event_date_time when calling Event., must be smaller than or equal to 29.');
        }
