...
class TransportProduct implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    const PRODUCT_UPS = 'UPS';
    const PRODUCT_FEDEX = 'FEDEX';
    const PRODUCT_POST_AT = 'POST_AT';
    const PRODUCT_GLS = 'GLS';
    const PRODUCT_DHL_EXPRESS = 'DHL_EXPRESS';
    const PRODUCT_SELF_PICKUP = 'SELF_PICKUP';
    const PRODUCT_RAIL = 'RAIL';
    const PRODUCT__3_GTMS = '3GTMS';
    const PRODUCT_ROAD = 'ROAD';
    const PRODUCT_SF = 'SF';
    ...
    public function getProductAllowableValues()
    {
        return [
            ...
            self::PRODUCT_UPS,
            self::PRODUCT_FEDEX,
            self::PRODUCT_POST_AT,
            self::PRODUCT_GLS,
            self::PRODUCT_DHL_EXPRESS,
            self::PRODUCT_SELF_PICKUP,
            self::PRODUCT_RAIL,
            self::PRODUCT__3_GTMS,
            self::PRODUCT_ROAD,
            self::PRODUCT_SF,
        ];
    }
