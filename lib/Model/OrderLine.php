...
class OrderLine implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['line_item_number']) && ($this->container['line_item_number'] > 99999)) {
     ...
     *
     * @param int|null $line_item_number unique customer line item number
     *
     * @return self
     */
    public function setLineItemNumber($line_item_number)
    {
        ...
        if (!is_null($line_item_number) && ($line_item_number > 99999)) {
