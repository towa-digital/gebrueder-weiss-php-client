...
class OrderReference implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    const QUALIFIER_CUSTOMERORDERID = 'customerorderid';
    const QUALIFIER_CUSTOMERREFERENCE = 'customerreference';
    const QUALIFIER_ORDERTYPE = 'ordertype';
    const QUALIFIER_GWORDERID = 'gworderid';
    const QUALIFIER_WAREHOUSELOCATION = 'warehouselocation';
    const QUALIFIER_DELIVERYNOTE = 'deliverynote';
    ...
    {
        return [
            self::QUALIFIER_CUSTOMERORDERID,
            self::QUALIFIER_CUSTOMERREFERENCE,
            self::QUALIFIER_ORDERTYPE,
            self::QUALIFIER_GWORDERID,
            self::QUALIFIER_WAREHOUSELOCATION,
            self::QUALIFIER_DELIVERYNOTE,
        ];
    }
    ...
    public function setReference($reference)
    {
        if (!is_null($reference) && (mb_strlen($reference) > 20)) {
            throw new \InvalidArgumentException('invalid length for $reference when calling OrderReference., must be smaller than or equal to 20.');
        }
