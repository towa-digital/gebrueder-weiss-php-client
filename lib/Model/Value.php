...
class Value implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    const QUALIFIER_GOODS_VALUE = 'GOODS_VALUE';
    const QUALIFIER_INSURANCE_VALUE = 'INSURANCE_VALUE';
    const QUALIFIER_CASH_ON_DELIVERY = 'CASH_ON_DELIVERY';
    ...
    {
        return [
            self::QUALIFIER_GOODS_VALUE,
            self::QUALIFIER_INSURANCE_VALUE,
            self::QUALIFIER_CASH_ON_DELIVERY,
        ];
    }
     ...
     * Sets qualifier
     *
     * @param string|null $qualifier type of amount
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param float|null $amount Amount expressed as a decimal number of major currency units
     *
     * @return self
     */
     ...
     * Sets currency
     *
     * @param string|null $currency currency following ISO-42-17, see https://en.wikipedia.org/wiki/ISO_4217
     *
     * @return self
     */
