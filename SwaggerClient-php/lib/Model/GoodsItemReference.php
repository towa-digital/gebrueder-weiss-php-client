 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GoodsItemReference implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GoodsItemReference';
...
self::QUALIFIER_CARRIERTRACKINGURL,        ];
     ...
     * Sets qualifier
     *
     * @param string $qualifier qualifier for the goodsitem
     *
     * @return $this
     */
